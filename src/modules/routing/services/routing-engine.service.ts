...
import { CanonicalFlowMessage } from '../../event/services';
...
export class RoutingEngineService {
  ...
  async evaluateRoute(
    ...
    for (const route of sortedRoutes) {
      ...
      if (route.sourceAE && route.sourceAE !== context.sourceAE) continue;
      if (context.targetAE && route.targetAE !== context.targetAE) continue;
  ...
  private evaluateCondition(message: CanonicalFlowMessage, condition: RouteCondition): boolean {
