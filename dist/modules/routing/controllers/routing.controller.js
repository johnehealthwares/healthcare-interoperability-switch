...
let RoutingController = class RoutingController {
    ...
    async getRoutes(tableId) {
        return (await this.routingService.getRoutingTable(tableId)).routes;
    }
...
__decorate([
    (0, common_1.Get)('tables/:id/routes'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RoutingController.prototype, "getRoutes", null);
__decorate([
