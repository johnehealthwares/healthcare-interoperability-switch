...
/** AE Creation Payload */
export type AECreatePayload = Omit<ApplicationEntityContract, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt'>;
/** AE Update Payload */
export type AEUpdatePayload = Partial<Omit<ApplicationEntityContract, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt'>>;
